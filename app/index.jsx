...
import { View, Text, TouchableOpacity, StyleSheet, FlatList, StatusBar, ActivityIndicator, ScrollView, Dimensions } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        >
          <AntDesign name={showFavorites ? 'star' : 'staro'} color='gold' size={28} />
        </TouchableOpacity>
